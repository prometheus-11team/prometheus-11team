...
def main():
    ...
    # 기본 데이터 경로
    stock_data_path = "./data/M7_stock_data_with_indicators.csv"
    macro_data_path = "./data/macro_indicators_2020_2025-03.csv"
    financial_data_path = "./data/M7_financial_data_2020_2025.csv"
    
    # 감정 분석 데이터 경로
    sentiment_data_paths = [
        "./data/M7_googlenews_2020_2022_sentiment_feature.csv",
        "./data/M7_reddits_2022_2025_sentiment_feature.csv"
    ]
    
    # Transformer 모델 경로
    transformer_model_path = "./models/transformer_classifier_best.pt"
