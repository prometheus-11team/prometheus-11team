...
def main():
    ...
    # 기본 데이터 경로
    stock_data_path = "./examples/data/M7_stock_data_with_indicators.csv"
    macro_data_path = "./examples/data/macro_indicators_2020_2025-03.csv"
    financial_data_path = "./examples/data/M7_financial_data_2020_2025.csv"
    
    # 감정 분석 데이터 경로
    sentiment_data_paths = [
        "./examples/data/M7_googlenews_2020_2022_sentiment_feature.csv",
        "./examples/data/M7_reddits_2022_2025_sentiment_feature.csv"
    ]
    
    # Transformer 모델 경로
    transformer_model_path = "./examples/models/transformer_classifier_best.pt"
    ...
    # # 모델 저장
    model_save_path = os.path.join("models", "td3_enhanced_model(3)")
    trained_model.save(model_save_path)
    print(f"\n💾 확장된 모델이 '{model_save_path}'에 저장되었습니다!")
    from stable_baselines3 import TD3

    model_save_path = os.path.join("models", "td3_enhanced_model(3).zip")
    trained_model = TD3.load(model_save_path)
